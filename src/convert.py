...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "../datasets-bot/datasets/crack_segmentation_dataset"
    datasets = ["train", "test"]
    ...
    for ds_name in datasets:
        ds_dir = os.path.join(dataset_path, ds_name)
        imd_dir = "images"
        ann_dir = "masks"

        images_path = os.path.join(ds_dir, imd_dir)
        ann_path = os.path.join(ds_dir, ann_dir)
